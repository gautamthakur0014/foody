...
const Contact = () => {
  ...
  return (
    <div className="min-h-scree bg-sky-100 text-black dark:text-white px-6 py-12 flex flex-col items-center">
      <h1 className="text-3xl md:text-4xl font-bold mb-4 text-black">
        Contact Us
      </h1>
      <p className="text-center text-black max-w-xl mb-10">
      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 text-black">
        ...
        <form
          ...
          className="bg-sky-200 p-6 rounded-lg shadow-lg space-y-4"
        >
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border   rounded-md bg-white   focus:outline-none focus:ring-2 focus:to-blue-700"
            />
          </div>
          <div>
